...
<script lang="ts">
	...
	const gridClass = $derived(
		`grid grid-cols-${headers.length + 1} preset-ghost-tertiary dark:preset-ghost-primary w-full items-start justify-start p-1 py-2 pl-3 text-center font-semibold`
	);
</script>
