...
<div class="flex w-full items-center gap-4">
	...
	<div class="flex items-center gap-2">
		...
		<button class="btn btn-icon btn-sm preset-ghost-surface" onclick={onRotateLeft} title="Rotate Left 90°">
			<iconify-icon icon="mdi:rotate-left"></iconify-icon>
		</button>
		<button class="btn btn-icon btn-sm preset-ghost-surface" onclick={onRotateRight} title="Rotate Right 90°">
	...
	<div class="flex items-center gap-2">
		...
		<button class="btn btn-icon btn-sm preset-ghost-surface" onclick={onFlipVertical} title="Flip Vertical">
