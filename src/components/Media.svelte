...
<div class="flex h-full flex-col gap-4">
	...
	<div class="flex items-center gap-2">
		...
		<input
			...
			disabled={isLoading}
		/>
		<button onclick={fetchMedia} class="preset-ghost-primary btn btn-sm" disabled={isLoading} aria-label="Refresh media">
	...
	{:else if error}
		...
		<div class="flex flex-1 items-center justify-center text-center">
			<div class="flex flex-col items-center gap-2">
				...
				<button onclick={fetchMedia} class="preset-filled-primary btn btn-sm"> Try Again </button>
			</div>
		</div>
