...
- If `field.required === true` → `validateOnMount = true` (auto-validate on mount)
- If `field.required === false` → `validateOnMount = false` (validate only on interaction)
...
│   ↓                                                                   │
│ RightSidebar: <button disabled={true}>Save</button> ✅                │
└─────────────────────────────────────────────────────────────────────┘
...
│   ↓                                                                   │
│ RightSidebar: <button disabled={false}>Save</button> ✅               │
└─────────────────────────────────────────────────────────────────────┘
